...
const links = [
  ...
  { name: "Discord", text: "Join the community", url: "https://discord.gg/kwsxKhdZDz", type: "discord" },
...
function Icon({ type }) {
  const icons = {
    ...
    tiktok: <path d="M12.53 0h3.91c.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03a10.4 10.4 0 0 1-4.2-.97c-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75a8.24 8.24 0 0 1-7.72 7.65 7.32 7.32 0 0 1-3.97-1A7.87 7.87 0 0 1 1.33 18c-.03-.5-.04-1-.01-1.48a7.9 7.9 0 0 1 2.58-4.96 7.3 7.3 0 0 1 4.08-1.72c.68-.01 1.36-.01 2.04-.01.01 1.49-.04 2.98-.04 4.47-.93-.3-2.05-.22-2.87.34a3.2 3.2 0 0 0-1.22 1.66c-.18.49-.13 1.03-.12 1.55.22 1.5 1.66 2.76 3.2 2.62a3.19 3.19 0 0 0 2.53-1.47c.17-.29.35-.59.36-.94.09-1.66.05-3.32.06-4.98.01-3.74-.01-7.47.02-11.2L12.53 0Z" />,
